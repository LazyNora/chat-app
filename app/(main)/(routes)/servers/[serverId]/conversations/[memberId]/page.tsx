...
const Page = async ({ params, searchParams }: PageProps) => {
	...
	const conversation = await getOrCreateConversation(profile.getId(), memberId, serverId);
	...
	const otherMember = memberOne.profileId === profile.getId() ? memberTwo : memberOne;
	return (
